...
const UserProfile = () => {
    ...
    return (
                ...
                {show ? (
                    <>
                        <div className="flex flex-col items-center pb-10">
                            ...
                            <img
                                className="w-24 h-24 mb-3 mt-5 rounded-full shadow-lg"
                            ...
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th
                                            scope="col"
                                            className="px-4 py-3 text-base flex items-center gap-8"
                                        >
                                            See
                                        </th>
                                    </tr>
                                    ...
                                    data.map((order:any, index:any) => (
                                        <tbody key={index}>
                                            <tr className="border-b dark:border-gray-700">
                                                <th
                                                    scope="row"
                                                    className="px-4 py-3 justify-center font-medium text-gray-900 whitespace-nowrap dark:text-white"
                                                >
                                                    {order.id}
                                                </th>
                                                <td className="px-4 py-3 justify-center items-center">
                                                    <Link
                                                        to={`/order/${order.id}/`}
        ...
        cursor-pointer bg-gray-40 ${isHovered ? "bg-gray-600" : "hover:bg-gray-600"
                                        ...
                                        // Esta es la otra opcion del if, si hay una imagen ?
                                        <div>
                                            <button
                                                onClick={removeImage}
                                                type="button"
